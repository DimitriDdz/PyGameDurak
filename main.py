...
while running:
    ...
    # text_create_server = font.render("Создать сервер", True, BLACK)
    # text_connect_to_server = font.render("Подключиться", True, BLACK)
    text_input_ip = font.render(input_ip_text, True, BLACK)

    # screen.blit(text_create_server, (110, 115))
    # screen.blit(text_connect_to_server, (115, 215))
